...
public class UpdateServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        updatedInvoice.setDistributionChannel(distributionChannel);
        updatedInvoice.setCustomerNumber(customerNumber);
        updatedInvoice.setCompanyCode(companyCode);
        updatedInvoice.setOrderAmount(orderAmount);
        updatedInvoice.setOrderCurrency(orderCurrency);
        updatedInvoice.setAmountInUSD(amountInUSD);
        updatedInvoice.setOrderCreation(orderCreation);
